...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Phase 0: Rightmove listing (LIGHT MODE — external interface)
   Phase 1: Extension popup (dark popup on dimmed Rightmove)
   Phase 2: Processing (abstract — no pipeline exposure)
   Phase 3: Report delivered (dark — Piega brand)
   ═══════════════════════════════════════════════════════════════════════════ */
